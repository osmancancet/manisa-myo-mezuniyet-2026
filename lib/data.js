...
export const MUSIC = {
  ...
  youtubeIds: [
    ...
    { id: "ICfGdpZCE1Q", title: "Başrol Sensin — Manifest" },
...
/* Mezuniyet Belgeleri Takdimi (mezunlar hocalarıyla sahneye çıkarken) — BÖLÜM BAZLI:
   aynı bölümün tüm programları aynı şarkıyı çalar. YouTube videoId. */
export const TAKDIM_MUSIC = {
  // İnşaat Bölümü
  "insaat-teknolojisi":                      "AdQ3JDLlmPI", // Game of Thrones
  // İstatistik Bölümü
  "buyuk-veri-analistligi":                  "-bTpp8PQSog", // Indiana Jones
  // Makine ve Metal Teknolojileri Bölümü → Misirlou (Pulp Fiction)
  "makine":                                  "2T8As2kzelk",
  "makine-resim-ve-konstruksiyon":           "2T8As2kzelk",
  "endustriyel-kalipcilik":                  "2T8As2kzelk",
  "imalat-yurutme-sistemleri-operatorlugu":  "2T8As2kzelk",
  // Elektronik ve Otomasyon Bölümü → Star Wars (Esra Hoca)
  "mekatronik":                              "dW9xbFLaatU",
  "dijital-donusum-elektronigi":             "dW9xbFLaatU",
  // Elektrik ve Enerji Bölümü → Mission: Impossible
  "elektrik":                                "XAYhNHhxN0A",
  "alternatif-enerji-kaynaklari":            "XAYhNHhxN0A",
  // Bilgisayar Teknolojileri Bölümü
  "bilgisayar-programciligi":                "78N2SP6JFaI", // Superman
};
