...
/* Mezuniyet Belgeleri Takdimi (mezunlar hocalarıyla sahneye çıkarken) — programın
   talep ettiği şarkı. Talebi olmayan programlarda giriş müziği (MUSIC.procession)
   çalar. YouTube videoId. */
export const TAKDIM_MUSIC = {
  "insaat-teknolojisi":            "AdQ3JDLlmPI", // İnşaat
  "elektrik":                      "XAYhNHhxN0A", // Elektrik
  "makine":                        "2T8As2kzelk", // Makine
  "buyuk-veri-analistligi":        "-bTpp8PQSog", // İstatistik (Büyük Veri Analistliği)
  "bilgisayar-programciligi":      "78N2SP6JFaI", // Bilgisayar
  "dijital-donusum-elektronigi":   "dW9xbFLaatU", // Dijital Dönüşüm — Esra Hoca özel parça (mevcut)
};
