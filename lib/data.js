...
export const CEREMONY_DATA = {
  ...
  programs: [
    ...
    // Dijital Dönüşüm Elektroniği ekrandayken Esra Hoca için özel parça çalar (genel geçiş müziği yerine).
    { ...P("dijital-donusum-elektronigi",     "Dijital Dönüşüm Elektroniği",          "Elektronik ve Otomasyon"), music: "dW9xbFLaatU" },
...
export const MUSIC = {
  ...
  youtubeIds: [
    ...
    { id: "ADMncJP_46w", title: "Yakar Geçerim (Rampapam 2.0 Remix) — Ajda Pekkan" },
